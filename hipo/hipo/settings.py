...
FOURSQUARE_CLIENT_KEY = get_secret('FOURSQUARE_CLIENT_KEY')
FOURSQUARE_VERSION = get_secret('FOURSQUARE_VERSION')
FOURSQUARE_VENUES_SEARCH = get_secret('FOURSQUARE_VENUES_SEARCH')
